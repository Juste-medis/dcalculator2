...
public class DatePickerFragment2 extends androidx.fragment.app.DialogFragment  implements DatePickerDialog.OnDateSetListener {
    @Override
    ...
    public static DatePickerFragment2 newInstance(int id, int year, int month, int day) {
        // create a new instance
        DatePickerFragment2 datePickerFragment1 = new DatePickerFragment2();
    ...
    public void onDateSet(DatePicker view, int year, int month, int day) {
        ...
        ((DureActivity)getActivity()).onDatePickerDialogDone(getArguments().getInt("id"), year, month, day);
    }
}